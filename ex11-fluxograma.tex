...
\begin{enumerate}
    ...
    \begin{description}
        ...
        \item [Endereço:] Recife - Casa Forte
        \item [Matrícula:] 300890553
        \item [CPF:] 708.827.084-65
        \item [RG:] 10.755.186
        \item [Telefone:] (81) 98875-7471
       % \item [Currículo Lattes:] \url{http://lattes.cnpq.br/nnnnn}
    \end{description}
    ...
    \begin{description}
        ...
        \item [Endereço:] Recife - Pina
        \item [Matrícula:] 300885168
        \item [CPF:] 704.730.344-84
        \item [RG:] 9.680.016
        \item [Telefone:] (81) 99229-1832
       % \item [Currículo Lattes:] \url{http://lattes.cnpq.br/nnnnn}
    \end{description}
