...
O programa do jogo Battle of Forro mostra primeiro o menu com duas opções, uma de sair e outra de começar, logo apos o jogo começar, voce sempre tera duas opcoes de escolha e no final uma opcao de sair do jogo. Neste artigo iremos apresentar o seu fluxograma completo.
